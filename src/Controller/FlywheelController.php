 ...
 * FlywheelController
 *
 * REST API controller for Capital Flywheel execution, capital allocation,
 * covered call recommendations, daily strategy planner, pre-trade confirmation,
 * forward cash flow calendar, and background flywheel engine orchestration.
 */
#[Route('/api/flywheel', name: 'api_flywheel_')]
class FlywheelController extends AbstractController
{
    /**
     * Initializes the flywheel controller.
     *
     ...
     * @param FinnhubService            $finnhubService  Market data client for earnings/dividends.
     ...
     * @param \App\Llm\LlmServiceRouter $llmRouter       Multi-provider LLM router.
    ...
    /**
     * Calculates optimal capital allocation and position sizing across screened stocks.
     *
     * @param Request $request HTTP request containing capital amount.
     * @return JsonResponse JSON allocation payload.
     */
    ...
    /**
     * Returns covered call sell recommendations for owned portfolio equity positions.
     *
     * @return JsonResponse JSON covered call suggestions.
     */
    ...
    /**
     * Returns the daily flywheel execution plan combining risk summary, early exits (BTC), and covered calls (STO).
     *
     * @param Request $request HTTP request containing optional risk cap override.
     * @return JsonResponse Daily strategy plan payload.
     */
    ...
    /**
     * Verifies trade parameters through AI guardrails prior to execution.
     *
     * @param Request $request HTTP request containing trade specifications.
     * @return JsonResponse Verification result payload.
     */
    ...
    /**
     * Generates hypothetical outcome scenarios for Cash-Secured Put and Covered Call strategies.
     *
     * @param string $symbol Target stock ticker.
     * @return JsonResponse Strategy scenario comparison.
     */
    ...
    /**
     * Builds interactive forward and historical cash flow calendar events (earnings, dividends, option expirations).
     *
     * @return JsonResponse Calendar timeline events and cash projection series.
     */
    ...
    /**
     * Retrieves cached market landscape analysis generated by the background Flywheel engine daemon.
     *
     * @return JsonResponse Cached landscape metrics.
     */
    ...
    /**
     * Dispatches the background flywheel engine CLI command asynchronously.
     *
